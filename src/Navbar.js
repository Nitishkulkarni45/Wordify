          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link
                  className="nav-link active  navi"
                  aria-current="page"
                  to="/"
                >
                  Home
              ...
              <li className="nav-item">
                <Link className="nav-link navi" to="/About">
                  About
                </Link>
              </li>
              <li className="nav-item">
                <button className="nav-link navii" onClick={handleIcon}>
                {icon?<i class="bi bi-brightness-high-fill"></i>:<i class="bi bi-brightness-high"></i>}
                </button>
              </li>
            </ul>
